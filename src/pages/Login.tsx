  ...
  useEffect(() => {
    const loginWithGithubCreds = async (username: string, token: string) => {
      ...
      try {
        ...
        // Fallback: Sign up user if they don't exist yet
        ...
        if (signUpError) {
          // If they already exist under standard auth or standard signup errors
        ...
        toast.error('GitHub authentication handshake interrupted.');
      } finally {
    ...
    if (githubToken && githubUser) {
      // Clean upURL parameters from history
